...
#
# Purpose: Inline network inspection — Zeek + Suricata SIEM EC2.
#
# Topology (minimum compute):
#   - 1 public subnet  (eu-central-1a): fck-nat instance
#   - 1 private subnet (eu-central-1a): SIEM EC2
#
# No TGW. No NAT Gateway. No IGW for private subnets.
# fck-nat.tf provides NAT for private subnet egress.
# Cross-VPC connectivity to bc-ctrl / bc-prd: add VPC peering when needed.
#--------------------------------------------------------------
...
# SSM for SIEM EC2, Secrets Manager for Wazuh credentials
#--------------------------------------------------------------
module "vpc_endpoints" {
  ...
  enable_kms             = true
  enable_sts             = true
  enable_secretsmanager  = true  # Wazuh/Zeek credentials
