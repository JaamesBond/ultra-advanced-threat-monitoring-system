...
- **Node Capacity**: bc-prd workers = `t3.medium` (t3.small fails, pod limit 11). bc-ctrl workers = `t3.medium` (Cilium + Tetragon + Falco only; Wazuh/MISP on EC2; eks_addons removed).
